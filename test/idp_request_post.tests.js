    ...
    describe('when request is invalid', function () {
      it('should return error if request has expired', function (done) {
        var req = {
          query: {},
          body: {
            SAMLRequest: base64(util.format(template, '1983-05-17T20:32:16.835Z', 'john@acme.com', 'abc'))
          }
        };
      ...
      it('should return error if SessionIndex is missing', function (done) {
        var req = {
          query: {},
          body: {
            SAMLRequest: base64(util.format(template, new Date().toISOString(), 'john@acme.com', ''))
          }
        };
      ...
      it('should return error if NameID is missing', function (done) {
        var req = {
          query: {},
          body: {
            SAMLRequest: base64(util.format(template, new Date().toISOString(), '', 'abc'))
          }
        };
      ...
      it('should return error if SessionIndex is invalid', function (done) {
        var req = {
          query: {},
          body: {
            SAMLRequest: base64(util.format(template, new Date().toISOString(), 'john@acme.com', 'invalid'))
          }
        };
